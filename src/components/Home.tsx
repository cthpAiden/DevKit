...
import { toolsByGroup, tools } from '../tools/registry'

export default function Home() {
  return (
    <div>
      <section className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight text-white">🧰 DevKit</h1>
        <p className="mt-2 max-w-2xl text-slate-400">
          A toolbox of {tools.length} everyday developer utilities. Everything runs{' '}
          <span className="font-semibold text-slate-200">100% in your browser</span> — no
          accounts, no uploads, your data never leaves your machine.
        </p>
      </section>
